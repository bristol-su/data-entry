            ...
            <b-col>
                <b-table
                    ...
                    <template v-slot:bottom-row="{columns}">
                        <td :colspan="columns" v-if="canStoreRow">
                    ...
                    <template v-slot:cell(actions)="data">
                        <b-button variant="outline-info" size="sm" @click="$emit('editRow', data.item)" v-if="canUpdateRow"><i class="fa fa-edit"/></b-button>
                        <b-button variant="outline-danger" size="sm" @click="$emit('deleteRow', data.item.row_id)" v-if="canDeleteRow"><i class="fa fa-trash"/></b-button>
                    </template>
