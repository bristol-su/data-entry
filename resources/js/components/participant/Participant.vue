<template>
    <div>
        <b-row>
            <b-col>
                <b-button variant="outline-secondary" :href="csvUrl">Download CSV</b-button>
                <b-button variant="outline-secondary" :href="templateUrl">Download CSV Template</b-button>
                <b-button variant="outline-secondary" @click="showCsvUpload = true">Upload CSV</b-button>
            </b-col>
            <b-col>
                <b-input-group>
